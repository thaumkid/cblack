...
*cblack* can be installed downloading this project and then running `python -m pip install path/to/cblack`. Consider using the -e option to make your install editable and keep up with future versions of black yourself.
